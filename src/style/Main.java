    ...
    TextField usuarioTxt = new TextField();
	 ...
	 @Override
	   public void start(Stage ventana) throws Exception {
	       ...
	       //Añadimos un borde a las celdas del grid
	       //Color de fondo de cada celda
	       //Al igual que en CSS las propiedades han de establecerse separadas por punto y coma
	       //Si volvemos a llamar a setStyle con el mismo control gráfico más adelante
	       //las propiedades se sobreescribirían perdiendo el estilo que le habiamos dado
